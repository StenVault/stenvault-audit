...
Built to audit [CloudVault](https://github.com/Gefson-costa/vault) (180K+ lines, AES-256-GCM, Argon2id, X25519 + ML-KEM-768, OPAQUE, Shamir), but the architecture is applicable to any codebase with security-critical code.
...
| Project | Purpose |
|---------|---------|
| [CloudVault](https://github.com/Gefson-costa/vault) | Zero-knowledge encrypted cloud storage (180K+ lines) |
